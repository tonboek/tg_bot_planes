...
#АН-12 Иркутсктан ерак очып китми
#АН-225 Киев
#АН-124 Киев
#Маршруты
...
Максимальная взлётная масса: 392т. \n<b>Ан-225 «Мрия» (в переводе с украинского - «мечта»)</b> является самым тяжёлым грузоподъёмным самолётом, когда-либо поднимавшимся в воздух. \
...
рекордов, что является рекордом само по себе.'
    ...
    if message.text == 'Ан-124 - 200 монет':
        ...
        await sleep(1)
        await flight_return(start = 'Киев', distance = 27, sec = 0.2)
